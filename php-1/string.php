...
$second_sentence = "I'm ready for the challenges"; // Panjang string: 28, jumlah kata: 5 echo 
// jawab
echo "Panjang string : ".strlen($first_sentence). ",jumblah kata :". str_word_count($first_sentence). "<br>";
echo "Panjang string : ".strlen($second_sentence). ",jumblah kata :". str_word_count($second_sentence). "<br>";

echo "<h3>Soal No 2</h3>"; /* SOAL NO 2 Mengambil kata pada string dan karakter-karakter yang ada di dalamnya. */
$string2 = "I love PHP"; echo "<label>String: </label> \"$string2\" <br>"; echo "Kata pertama: " . substr($string2, 0, 1) . "<br>" ; // Lanjutkan di bawah ini echo "Kata kedua: " ; echo "<br> Kata Ketiga: " ;
// jawab
...
$string3 = "PHP is old but sexy!"; echo "String: \"$string3\" "; // OUTPUT : "PHP is old but awesome" 
//jawab
